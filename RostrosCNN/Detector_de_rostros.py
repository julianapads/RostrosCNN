...
#    return kernel
#
#def crear_circulos(coords, img):
#    
#    cv2.circle(img,(coords[0],coords[1]),2,255,7)
##    circle = plt.Circle(coords,.2,color='r')
##    img.add
#
#while(1):
#    print('BIENVENIDO \n Existen ',len(imgs), ' imagenes para probar la neurona.\n')
#    msj = str("Digite el numero de la imagen para usar de entrada, valores entre 1 - "+str(len(imgs))+": ")
#    opc = int(input(msj))
...
#y, x, _ = imagen.shape
#
#newModel = tf.keras.models.load_model('Red_face4')  
#newModel.summary()
#n=64
